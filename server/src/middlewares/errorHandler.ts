 ...
 * сюда, поэтому обёртки вида asyncHandler больше не нужны — в Express 4 без них
 * ошибка из async-роута просто вешала запрос.
 *
...
export function errorHandler(
  ...
  res.status(500).json({
    ...
    error: {
      ...
      // Текст ошибки отдаём только в dev: в проде он часто содержит куски SQL,
      // пути на диске и прочее, что показывать не стоит.
